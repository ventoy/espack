...
struct sec_per_clus_table _cluster_size_table16[] =
{
    ...
    { 262144, 32},   // 128MB - 16K
    { 524288, 64},   // 256MB - 32K
    { 1048576, 128}, // 512MB - 64K
    { 2097152, 128}, // 1GB - 64K
    { 4194304, 128}, // 2GB - 64K
    { 8388608, 128},// 4GB - 64K [Warning only supported by Windows XP onwards]
    { 0 , 0 }       // Invalid
};
...
struct sec_per_clus_table _cluster_size_table32[] =
{
    ...
    { 4194304, 64}, // 2GB - 32K
    { 8388608, 64}, // 4GB - 32K
    { 16777216, 128}, // 8GB - 64K
    { 33554432, 128},  // 16GB - 64K
    { 67108864, 128},  // 32GB - 64K
    { 0xFFFFFFFF, 128},// >32GB - 64K
    { 0 , 0 }         // Invalid
};
